...
- **Odluka**: brojimo odvojeno:
  ...
  2. **ponovljena putanja slike** - isti kadar upisan više puta (ista slika, možda druge
     brojke);
  3. **ponovljena četvorka mjerenja** (steering, throttle, brake, speed) uz **različitu**
     sliku: očekivano i bezopasno kod rešetkastog steeringa, jer je prostor vrijednosti mali.
